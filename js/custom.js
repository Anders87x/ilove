...
setInterval(function() {
    var timespan = countdown(new Date("10/11/2020"), new Date());
    var div = document.getElementById('time');
    div.innerHTML = "<div><span>Años</span>" + timespan.years + "</div>" + "<div><span>Meses</span>" + timespan.months + "</div>" + "<div><span>Días</span>" + timespan.days + "</div>" + "<div><span>Horas</span>" + timespan.hours + "</div>" + "<div><span>Minutos</span>" + timespan.minutes + "</div>" + "<div><span>Segundos</span>" + timespan.seconds + "</div>"
}, 1000);
